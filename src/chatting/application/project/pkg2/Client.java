...
public class Client implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
     ...
     //dout.setBackground(new Color(7,94,84));
     dout.writeUTF(out);
    ...
    public static void main(String [] args)
    {
        ...
        try
        {
           //To connect with the server we create a socket.
            Socket s = new Socket("127.0.0.1",6001);//as we are working on the local host, we write the address and port no. of the server.
            ...
            while(true)
                {
                    a1.setLayout(new BorderLayout());
                    String msg = din.readUTF();//msg is read here
